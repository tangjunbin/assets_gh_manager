...
public class AssetsRetreatModel extends AssetsModel {
    private String TAG = "AssetsRetreatModel";
    @Override
    public void getAssetsList(String query, int p, int limit, Map<String, Object> orderMap, Callback callback) {
        ...
        http.asyncGet(ConfigBase.host_url + ConfigBase.Api.Assets_retreat_query,
                    ...
                    public void onSuccess(String result) {
                        ...
                        if(code == 0) {
                            ...
                            if(result_list.size()>0){
                                assetsPageData.setListAssetsRetreatBill(JSONObject.parseArray(JSONObject.toJSONString(result_list), AssetsRetreatData.class));
