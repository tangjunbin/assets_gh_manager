...
public class GroupListViewFragment extends BaseFragment {
    ...
    private void initGroupListView() {
        ...
        XUICommonListItemView itemWithDetailBelow = mGroupListView.createItemView("AItem 3");
        itemWithDetailBelow.setOrientation(XUICommonListItemView.VERTICAL);
        itemWithDetailBelow.setDetailText("在标题下方的详细信息");

        XUICommonListItemView itemWithChevron = mGroupListView.createItemView("AItem 4");
        itemWithChevron.setAccessoryType(XUICommonListItemView.ACCESSORY_TYPE_CHEVRON);

        XUICommonListItemView itemWithSwitch = mGroupListView.createItemView("AItem 5");
        ...
        XUICommonListItemView itemWithCustom = mGroupListView.createItemView("AItem 6");
