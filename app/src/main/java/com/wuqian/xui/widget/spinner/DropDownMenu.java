...
package com.wuqian.xui.widget.spinner;
...
public class DropDownMenu extends LinearLayout {
    ...
    public void setTabMenuText(String text) {
        if (mCurrentTabPosition != -1) {
            ...
            if(mCurrentTabPosition>0)
                ((TextView) mTabMenuView.getChildAt(mCurrentTabPosition)).setTextColor(mMenuTextSelectedColor);
            else
     ...
     * @param text
     */
    public void setTabMenuText(String text,int postion) {
        if (mCurrentTabPosition != -1) {
            ((TextView) mTabMenuView.getChildAt(mCurrentTabPosition)).setText(text);
            if(postion>0)
                ((TextView) mTabMenuView.getChildAt(mCurrentTabPosition)).setTextColor(mMenuTextSelectedColor);
