...
package com.gh.wuqian.fragment.expands.qrcode;
...
import com.gh.wuqian.base.webview.WebViewInterceptDialog;
...
public class CustomCaptureActivity extends CaptureActivity implements View.OnClickListener {
    ...
    private boolean isAppLink(String url) {
        ...
        return uri != null
                && WebViewInterceptDialog.APP_LINK_HOST.equals(uri.getHost())
    ...
    private void openAppLink(Context context, String url) {
        try {
            Intent intent = new Intent(WebViewInterceptDialog.APP_LINK_ACTION);
