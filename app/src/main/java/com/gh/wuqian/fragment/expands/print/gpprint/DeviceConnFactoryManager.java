...
package com.gh.wuqian.fragment.expands.print.gpprint;
                            ...
                            if (result == 0) {//打印机状态查询
                                ...
                                if (whichFlag) {
                                    ...
                                    if ((buffer[0] == ESC_LOW_POWER)) {
                                        status = MyApp.getContext().getString(R.string.str_low_power);
                                    } else if ((buffer[0] == ESC_AMID_POWER)) {
                                        status = MyApp.getContext().getString(R.string.str_amid_power);
                                    } else if ((buffer[0] == ESC_HIGH_POWER)) {
                                        status = MyApp.getContext().getString(R.string.str_high_power);
                                    } else if ((buffer[0] == ESC_CHARGING)) {
                                        status = MyApp.getContext().getString(R.string.str_charging);
                                    }
                                }
